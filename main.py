...
'''
def activate_ep():
    os.system("sudo su -c \"echo '\_SB.PCI0.LPC0.EC0.VPC0.DYTC 0x0012B001' > /proc/acpi/call\"")
...
'''
def activate_bs():
    os.system("sudo su -c \"echo '\_SB.PCI0.LPC0.EC0.VPC0.DYTC 0x0013B001' > /proc/acpi/call\"")
